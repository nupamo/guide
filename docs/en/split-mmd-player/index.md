...
- (Latest as of 2026-06-16) Unity `2022.3.22f1` / VRChat SDK `3.10.3` / Gesture Manager `3.9.8` / VRCFury `1.1341.0` / Modular Avatar `1.17.1` / NDMF `1.13.1` / wholesome SPS Configurator `2.0.11`
...
5. Assign `Motion VMD` or a Unity `AnimationClip`, `Audio Clip`, and optionally `Camera VMD` and `Lip VMD`.
